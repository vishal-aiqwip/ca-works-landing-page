...
const FAQS = [
  {
    q: "What is CA Works?",
    a: "CA Works is an AI client-communication layer for chartered accountants that handles conversations, document collection and reminders over WhatsApp.",
  },
  {
    q: "Which channels does it support?",
    a: "WhatsApp Business today, unified into a single inbox and thread per client — with Email and more channels on the way.",
  },
  {
    q: "Do my clients need to install anything?",
    a: "No. Clients keep using the WhatsApp they already use — CA Works works behind your firm's existing channel.",
  },
  {
