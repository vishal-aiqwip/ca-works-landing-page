...
function NavItem({
  ...
  return (
    ...
    >
      <span className="flex size-[18px] flex-none items-center justify-center rounded">
        {icon}
      </span>
      {label}
    </div>
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        <div className="flex justify-between gap-2">
          ...
          <span className="flex-none font-semibold text-[#A9B4BD] text-[11px]">
            {ago}
          </span>
        </div>
        <div className="mt-0.5 overflow-hidden text-ellipsis whitespace-nowrap text-[#7A8893] text-[13px]">
          {preview}
        </div>
      </div>
    </div>
...
function ProductDemo() {
  ...
  useEffect(() => {
    ...
    const getPos = (ref: RefObject<HTMLDivElement | null>) => {
      ...
      return {
        left: er.left - cr.left + 24,
        top: er.top - cr.top + er.height / 2 - 1,
      };
    };
    ...
    const runCycle = () => {
      ...
      clickNav(rmNavRef, 5300);
      clickNav(docNavRef, 10100);
      ...
      schedule(() => switchTo("rm"), 5300);

      schedule(() => switchTo("doc"), 10100);
      schedule(() => setDocSelected(true), 11800);
      ...
      >
        <div className="flex items-center gap-3.5 border-[#F0F3F9] border-b bg-[#FBFCFE] px-4.5 py-3">
          ...
          <div className="mx-auto flex max-w-[340px] flex-1 items-center justify-center">
            <span className="font-bold text-[#7A8893] text-[13px]">
              CA Works
            </span>
          </div>
        ...
        <div className="flex items-center gap-4 border-[#EEF2F8] border-b bg-white px-4.5 py-2.5">
          <div className="flex items-center gap-2.5">
            <div
              ...
              style={{
                background: "#0464E4",
                boxShadow: "0 4px 12px rgba(4,100,228,.32)",
              }}
            >
              CA
            </div>
            <span className="font-extrabold text-[#1C2A33] text-[15px] tracking-[-0.01em]">
              Works
            </span>
          </div>
          <div className="ml-auto flex flex-[0_1_320px] items-center gap-2 rounded-lg bg-[#F3F6FD] px-3 py-1.5">
            <SearchIcon />
            <span className="text-[#A9B4BD] text-[13px]">
        ...
        <div
          ...
          style={{
            ...
            transition:
              "left .85s cubic-bezier(.4,0,.2,1), top .85s cubic-bezier(.4,0,.2,1), opacity .3s ease",
          }}
        >
          <svg
            aria-hidden="true"
        ...
        <div className="grid min-h-[580px] grid-cols-[250px_1fr_360px]">
          <div className="border-[#F0F3F9] border-r bg-[#FBFCFE] p-3.5">
            ...
            <div className="flex flex-col gap-0.5">
              <NavItem
                navRef={docNavRef}
                active={channel === "doc"}
                bounce={navBounce === "doc"}
                icon={<FolderOrDocsIcon />}
                label="Documents"
              />
          ...
          <div className="flex flex-col overflow-hidden border-[#F0F3F9] border-r">
            <div className="border-[#F0F3F9] border-b px-4.5 py-3.5 font-bold text-[15px]">
              {listTitle}
            </div>
                  ...
                  <div key={group.label}>
                    ...
                    {group.items.map((item) => (
                      ...
                      >
                        ...
                        <div className="min-w-0 flex-1">
                          <div className="font-bold text-[#1C2A33] text-[13.5px]">
                            {item.title}
                          </div>
                          <div className="mt-px text-[#7A8893] text-[12px]">
                            {item.sub}
                          </div>
                        </div>
              ...
              {channel === "doc" &&
                DOC_FOLDERS.map((f) => (
                  <div
                    ...
                    style={{
                      background:
                        docSelected && f.id === "ST" ? "#F6F9FE" : undefined,
                      borderLeft:
                        docSelected && f.id === "ST"
                          ? "3px solid #0464E4"
                          : "3px solid transparent",
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="font-bold text-[#1C2A33] text-[14px]">
                        {f.name}
                      </div>
                      <div className="mt-px text-[#7A8893] text-[12px]">
                        {f.count} files
          ...
          <div
            ...
            style={{ background: channel === "wa" ? "#EFE7DE" : "#FBFCFE" }}
          >
            {channel === "wa" && (
              <>
                <div className="flex items-center gap-2.5 bg-[#008069] px-4 py-2.5">
                  ...
                  <div>
                    ...
                    <div className="font-medium text-[11px] text-[rgba(255,255,255,.8)]">
                      online
                    </div>
                  </div>
                ...
                <div
                  ...
                  style={{
                    backgroundImage:
                      "radial-gradient(rgba(11,20,26,.04) 1px,transparent 1px)",
                    backgroundSize: "22px 22px",
                  }}
                >
                  {waStep >= 1 && (
                    <div
                      className="animate-[wa-in_.32s_cubic-bezier(.22,1,.36,1)_both] self-end rounded-tl-lg rounded-tr-none rounded-br-lg rounded-bl-lg bg-[#D9FDD3] px-2.5 pt-1.5 pb-1 text-[#111B21] text-[13px] leading-[1.4] shadow-[0_1px_.5px_rgba(11,20,26,.13)]"
                      style={{ maxWidth: "80%" }}
                    >
                      Hi, can you please upload the balance invoices for the
                      month of March.
                  ...
                  {waStep === 3 && (
                    <div className="flex animate-[wa-in_.32s_cubic-bezier(.22,1,.36,1)_both] items-center gap-1 self-start rounded-tl-none rounded-tr-lg rounded-br-lg rounded-bl-lg bg-white px-3.5 py-2.5 shadow-[0_1px_.5px_rgba(11,20,26,.13)]">
                      ...
                      <span
                        className="size-[7px] animate-[wa-blink_1.2s_infinite] rounded-full bg-[#8696A0]"
                  ...
                  {waStep >= 4 && (
                    <div
                      className="animate-[wa-in_.32s_cubic-bezier(.22,1,.36,1)_both] self-start rounded-tl-none rounded-tr-lg rounded-br-lg rounded-bl-lg bg-white px-2.5 pt-1.5 pb-1 text-[#111B21] text-[13px] leading-[1.4] shadow-[0_1px_.5px_rgba(11,20,26,.13)]"
                      style={{ maxWidth: "82%" }}
                    >
                      ...
                      <div className="mt-1.5 flex items-center gap-2.5 rounded-lg border border-[#E3E5E5] bg-[#F5F6F6] px-2.5 py-1.5">
                        ...
                        <span className="min-w-0">
                          <span className="block font-bold text-[#111B21] text-[12px]">
                            March-Invoices.zip
                          </span>
                          <span className="block text-[#667781] text-[11px]">
                            2.4 MB
                          </span>
                        </span>
                      </div>
                      <span className="mt-0.5 block text-right text-[#667781] text-[10px]">
                        10:25
                      </span>
                    </div>
                  )}
                ...
                <div className="flex items-center gap-2.5 bg-[#F0F2F5] px-3.5 py-2.5">
                  <div className="flex flex-1 items-center gap-2.5 rounded-full bg-white px-3.5 py-2.5">
                    <MicIcon />
                    <span className="flex-1 text-[#8696A0] text-[13px]">
                      Edit or send AI reply…
                    </span>
                    <LikeIcon />
                  </div>
                  <button
              ...
              <>
                <div className="flex items-center gap-3 border-[#EEF2F8] border-b bg-white px-5.5 py-4.5">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="mt-0.5 text-[#7A8893] text-[12px]">
                ...
                <div className="flex flex-1 flex-col gap-3.5 bg-[#FBFCFE] px-5.5 py-5">
                  <div className="flex gap-3">
                    <div className="flex-1 rounded-xl border border-[#EEF2F8] bg-white px-3.5 py-3">
                      ...
                      <div className="mt-1 font-bold text-[#1C2A33] text-[15px]">
                        18 Jul · 9:00 AM
                      </div>
                    </div>
                    <div className="flex-1 rounded-xl border border-[#EEF2F8] bg-white px-3.5 py-3">
                  ...
                  <div className="rounded-xl border border-[#EEF2F8] bg-white px-3.5 py-3.5">
                    ...
                    <div className="rounded-lg bg-[#F6F9FE] px-3.5 py-3 text-[#2C3A45] text-[13px] leading-[1.55]">
                      Hi <b>Mehta Imports</b>, a quick reminder that your{" "}
                      <b>GSTR-3B for June</b> is due on <b>20 Jul</b>. Please
                      confirm your sales figures so we can file on time. — CA
                      Works
                    </div>
                  </div>
                </div>
              ...
              <>
                <div className="border-[#EEF2F8] border-b bg-white px-5.5 py-4">
                  ...
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      <div className="font-bold text-[#1C2A33] text-[16px]">
                        Sharma Textiles
                      </div>
                      <div className="mt-0.5 text-[#7A8893] text-[12px]">
                        24 files · auto-filed by CA Works
                      </div>
                    </div>
                  </div>
                </div>
