...
const Testimonials = () => {
  return (
    <section className="mx-auto max-w-[1080px] px-8 py-[84px]">
      <div className="mb-12 text-center">
        <div className="mb-3 font-extrabold text-[#0464E4] text-[13px] uppercase tracking-[0.1em]">
          Loved by practitioners
        </div>
        <h2 className="font-extrabold text-[42px] leading-[1.1] tracking-[-0.025em]">What CA firms say</h2>
      </div>
      <div className="grid grid-cols-1 gap-5 md:grid-cols-3">
        {QUOTES.map((q) => (
          ...
          >
            ...
            <p className="mb-5 flex-1 font-medium text-[#2C3A45] text-[15px] leading-[1.6]">{q.text}</p>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="font-semibold text-[#7A8893] text-[12px]">{q.firm}</div>
              </div>
            </div>
          </div>
        ))}
