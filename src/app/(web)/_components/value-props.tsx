  ...
  return (
    <section className="mx-auto max-w-[95%] px-4 py-10 sm:px-6 sm:py-16 lg:px-8">
      <div className="mb-[54px] text-center">
        <div
          data-reveal
          className="font-extrabold text-[13px] text-primary uppercase tracking-[0.1em]"
        >
          Why CA Works
        </div>
      </div>
      <div
        className="grid grid-cols-2 gap-4.5 md:grid-cols-4"
        data-reveal-group
      >
        {STATS.map((stat) => (
          <div key={stat.value} data-reveal-item className="p-2 text-center">
